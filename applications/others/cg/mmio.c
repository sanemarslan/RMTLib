...
char  *mm_typecode_to_str(MM_typecode matcode)
{
	...
	types[0] = (char *) calloc((MM_MAX_TOKEN_LENGTH/4), sizeof(char));
	types[1] = (char *) calloc((MM_MAX_TOKEN_LENGTH/4), sizeof(char));
	types[2] = (char *) calloc((MM_MAX_TOKEN_LENGTH/4), sizeof(char));
	types[3] = (char *) calloc((MM_MAX_TOKEN_LENGTH/4), sizeof(char));
