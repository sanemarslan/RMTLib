...
int main(int argc, char *argv[]) {
	...
	//fprintf("Number of threads: %d", openblas_get_num_threads());
	...
	if(basicOps){
		...
		# ifdef ENABLE_RMT 
			  activateRMT("f-L-lp-lp-2d-l-l-l-1dC-l-l-l-1dC-i-ipC", &ConjugateGradientSolver, 13, II, J, A, M, N, M, N, nz , b, N, M_Vector, N_Vector, 
																	  nz_vector, x, nz_vector, iterationNumber, &ret_code);	
			# else 			
				ConjugateGradientSolver(II,J,A,M,N,nz,b,M_Vector,N_Vector,nz_vector, x, iterationNumber, &ret_code);
			# endif
